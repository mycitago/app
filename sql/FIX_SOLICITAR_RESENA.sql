-- ============================================================
-- MyCitaGo · FIX DEFINITIVO · Solicitar reseña
-- Corrige: function gen_random_bytes(integer) does not exist
-- ============================================================

begin;

-- Supabase usa normalmente el schema extensions para extensiones.
create schema if not exists extensions;

-- Instalar pgcrypto si aún no existe.
create extension if not exists pgcrypto with schema extensions;

-- Si pgcrypto ya estaba instalado en otro schema (por ejemplo public),
-- moverlo a extensions para que la llamada sea determinista.
alter extension pgcrypto set schema extensions;

-- ------------------------------------------------------------
-- RPC usado por admin/agenda.html → "Solicitar reseña"
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Guardar reseña MyCitaGo verificada
-- ------------------------------------------------------------
